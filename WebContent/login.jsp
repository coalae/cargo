...
<html class="no-js">
    ...
    <body>
     ...
     <a href="loginKunde.jsp" class="btn btn-default btn-contact wow fadeInDown" data-wow-delay=".7s" data-wow-duration="500ms">KUNDEN-LOGIN</a>

<br>

     <a href="loginMitarbeiter.jsp" class="btn btn-default btn-contact wow fadeInDown" data-wow-delay=".7s" data-wow-duration="500ms">MITARBEITER-LOGIN</a>
