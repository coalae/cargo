...
<html class="no-js">
 ...
 <!-- TODO: PROFIL HIER AN MITARBEITER ANPASSEN -->
  ...
  <br>
                                <span>Mentoringdaten:</span><br>
                      <!--          <span class="cd-words-wrapper">
                                    <b class="is-visible">CarGo Driving School</b>
                                    <b>CarGo Fahrschule</b>
                                </span> -->
                                </h1>
                                <h2><span>Änderungen im entsprechenden Feld eintragen</span><br></h2>
                                </section> <!-- cd-intro -->
                                <!-- /.slider -->
			...
			<%SimpleDateFormat sdf = new SimpleDateFormat("yyyy");%> 
					...
					<form action="MentoringAendernServlet" Method="POST" >
						  ...
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Mentorid: </span><br>
                          <span><%=ausgewaehltesMentoring.getMentorId()%></span><br>
                          </select> </h2>
						  
						 
                          						  
                           <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Menteeid: </span><br>
                          <span><%=ausgewaehltesMentoring.getMenteeId()%></span><br>
                          </select> </h2>						  
						  ...
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Thema:</span><br>						  
                          <input type="text" name="thema" placeholder="<%=ausgewaehltesMentoring.getThema()%>">
						  <br> </h2>
	
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Beginnjahr:</span><br>
                          <input type="text" name="beginnjahr" id="datepickerBeginnJahr" placeholder="<%=sdf.format(ausgewaehltesMentoring.getBeginnJahr())%>">
            			  <br> </h2>
