    ...
    <body>
        ...
        <section id="hero-area" >
                    ...
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <section class="cd-intro">
                                ...
                                <span>Kundenaccount erstellen:</span><br><br>
			...
			<%KundenMgmt km = new KundenMgmt();%>
					...
					<form action="KundeRegistrierenServlet" Method="POST" >
						  ...
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>IBAN (Kontonummer):</span><br>
                          <input type="number" min = "1" step="1" name="iban" required>
						  <br> </h2>	

                          <h2><span>BIC (Bank-Code):</span><br>
						  ...
						  <br>
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
						  <span>	  <input type="submit" value="Kundenaccount erstellen"> </span> 
						  </h2>
