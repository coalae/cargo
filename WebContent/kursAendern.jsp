...
<!-- TODO: PROFIL HIER AUF MITARBEITER ANPASSEN -->
        ...
        <section id="hero-area" >
                    ...
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <section class="cd-intro">
                                ...
                                <span>Kursdaten abfragen:</span><br>
			...
			<%ArrayList<Kurs> kursliste = km.getKursListe();%>
					...
					<form action="KursAendernServlet" Method="GET" >
						
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                          <span>Kursname auswaehlen:</span><br><br>
						  <select name="kursname" required>  						  
  						    <%for(int i=0; i<kursliste.size();i++) {%>
  						  	 <%String name = kursliste.get(i).getKursname();%>
  						   	 <option value="<%=name%>"><%=kursliste.get(i).getKursname()%></option>  						   	 
  						  <%} %>
                          </select> </h2>
						  <h2 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
						  <input type="submit" value="Kursdaten abfragen">   
						  </h2>
