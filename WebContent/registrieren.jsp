                    ...
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <section class="cd-intro">
                                ...
                                <span>Registrierung</span><br>
                                </span> 
                                </h1>
                                </section> <!-- cd-intro -->
                                <!-- /.slider -->

     <a href="kundeRegistrieren.jsp" class="btn btn-default btn-contact wow fadeInDown" data-wow-delay=".7s" data-wow-duration="500ms">Kundenaccount erstellen</a>
