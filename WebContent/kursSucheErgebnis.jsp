...
<html class="no-js">
 ...
 <br>
			...
			<%ArrayList<Kurs> suchliste=km.getKursByKeyword(keyword); %>    
                          ...
                          <span>Suchergebnisliste: </span><br><br>				
                          	...
                          	<table class="table table-striped">
								 ...
								 <%int freiePlaetze=suchliste.get(i).getMaxAnzahl()-suchliste.get(i).getTeilnehmerliste().size();%>
								  	<tr>
								  		<td><div align="center"><h3><a href="KursAnzeigenServlet?param1=<%=suchliste.get(i).getId()%>"> Kurs anzeigen <%// =suchliste.get(i).getId()%></a></h3></div></td>    
								  		<td><div align="center"><h3><%=suchliste.get(i).getKursname() %></h3></div></td>
								  		<td><div align="center"><h3><%=suchliste.get(i).getLevel() %></h3></div></td>
								  		<td><div align="center"><h3><%=sdf.format(suchliste.get(i).getBeginn().getTime()) %></h3></div></td>
								  		<td><div align="center"><h3><%=sdf.format(suchliste.get(i).getEnde().getTime()) %></h3></div></td>
								  		<td><div align="center"><h3><%=suchliste.get(i).getBetreuerId() %></h3></div></td>
								  		<td><div align="center"><h3><%=suchliste.get(i).getImmobilie() %></h3></div></td>
								  		<td><div align="center"><h3><%=freiePlaetze%></h3></div></td>
								  		<td><div align="center"><h3><%=suchliste.get(i).getMaxAnzahl()%></h3></div></td>
								  	</tr>
							<%}%>
							</table>			
